					...
					<div title="About" style="margin-left:0px">
						<div class="list-group">
							...
							<a href="#" class="list-group-item">${message }Dapibus ac
								...
								consectetur ac</a> 
							<a href="#" class="list-group-item">Vestibulum
								at eros</a>
						</div>
					</div>
				</div>
				...
				<script type="text/javascript">
					...
					function jsons(data, start, end) {
						...
						for(var i = start ; i < end ; i++) {
							html += "<tr><td>"+data[i].ctype+"</td><td>"+data[i].cname+"</td><td>"+data[i].ccolor+"</td><td>"+data[i].cprice+"</td><td>"+data[i].ccard+"</td><td>"+data[i].status.name+"</td><td><a href='#')\">删除</a></td></tr>";
						}
						$("#tb").html(html);
					}
				</script>
